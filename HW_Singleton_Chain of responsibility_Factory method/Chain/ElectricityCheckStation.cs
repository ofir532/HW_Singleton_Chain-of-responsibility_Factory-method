...
{
    internal class ElectricityCheckStation : GarageTest
    {
        public override void HandleCar(Car car)
        {
            ...
            if (test >= 6)
            {
                Console.WriteLine($"The test end for {car.Brand} without finding the problem. Next test is in the electric Station");
                if (nextCheck != null)
